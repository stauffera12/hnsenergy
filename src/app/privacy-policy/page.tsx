      ...
      <main>
        ...
        <div className="flex justify-center pb-10 bg-white">
          <div className="bg-white w-[85%]">
            <div className="">
              <h2 className="text-[34px] font-semibold mb-1 text-[#444444]">
                Who we are
              </h2>
              <p className="mb-4 text-[#676767]">
                Our website address is: https://hnsenergyproducts.com.
              </p>
            </div>
            <div className="">
              <h2 className="text-[34px] font-semibold mb-1 text-[#444444]">
              ...
              <span className="text-[24px] font-semibold mb-1 text-[#444444]">
                Comments
              </span>
              <p className="mb-4 text-[#676767]">
            ...
            <div className="">
              ...
              <p className="text-[24px] font-semibold mb-1 text-[#444444]">
