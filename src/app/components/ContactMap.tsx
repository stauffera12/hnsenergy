          ...
          <div className="flex max-sm:flex-col bg-white rounded-[10px] w-[85%] shadow ">
            ...
            <div className=" px-[40px] w-full max-sm:px-[10px] max-sm:pt-[30px] pt-[80px] flex flex-col gap-[20px] text-black">
              <div className="grid grid-cols-2 gap-[20px] ">
                <div>
                  ...
                  <input
                    ...
                    className={
                      isInputFocused
                        ? "outline-red py-2 p-2 map"
                        : "outline-none py-2 p-2"
                    }
                    placeholder="Name"
                ...
                <div>
                  ...
                  <input
                    ...
                    className={
                      isInputFocused
                        ? "outline-red py-2 p-2 w-full pa"
                        : "outline-none py-2 p-2 w-full"
                    }
              ...
              <div className="grid grid-cols-2 max-sm:gap-[10px] gap-[20px]">
                <div>
                  <label htmlFor="phoneInput" className="text-[14px]">
                    Phone
                  </label>
                  <input
                    id="phoneInput"
                ...
                <div className="w-[100%] ">
                  ...
                  >
                    ...
                    <option value="CustomerComplaints">
                      Customer Complaints
                    </option>
              ...
              <div>
                <label htmlFor="messageInput" className="text-[14px]">
                  Message
                </label>
                <div className="relative">
                  <textarea
                    ...
                    className={`
                     ...
                     ${
                       isInputFocused
                         ? "outline-red py-2 p-2 w-full h-[15vh] "
                         : "outline-none py-2 p-2 w-full h-[15vh] "
                     }
                    `}
                  ...
                  <button
                    ...
                    className=" absolute right-[-40px] max-sm:right-[-10px] bottom-[-40px] max-sm:bottom-0 p-2 cursor-pointer"
                    aria-label="Send"
                  >
