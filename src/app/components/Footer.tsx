        ...
        <div className="w-[85%] py-[55px] grid grid-cols-4  max-sm:grid-cols-1 text-white gap-[20px]">
          <div className=" flex flex-col max-sm:text-center ">
            ...
            <span className=" leading-[24px]">
              H&S Energy Products, LLC – leading the industry as
            </span>
            <span className=" leading-[24px]">
              a major gasoline and convenience store retailer in California with
              an expanding footprint throughout the West Coast.
            </span>
          </div>
          ...
          <div className="flex flex-col gap-[30px] max-sm:justify-center max-sm:text-center max-sm:items-center">
            ...
            <div className="flex gap-[20px] items-center">
              <a
                ...
                className="text-white hover:text-[#9b9b9b] transition-colors duration-300"
                aria-label="LinkedIn"
              >
