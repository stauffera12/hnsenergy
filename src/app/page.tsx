...
export default function Home() {
  return (
    <div className="bg-white">
      <Header />
      <main className=" pt-[80px] max-sm:pt-0 block">
        <SlideBanner />
        <OurServices />
        <Become />
          ...
          <div className="flex max-sm:flex-col-reverse gap-[30px] p-[100px] max-sm:p-[20px] flex-row-reverse">
            <div className="text-[#0e0e0e] text-[14px] w-[50%] max-sm:w-[100%]">
              ...
              <p className="text-[14px] mb-4 leading-[28px]">
                ...
                safest convenience stores you can visit.
              </p>
              <p className="text-[14px] mb-4 leading-[28px]">
                Since then, we have built and acquired a great number of stores
                under the Chevron, Texaco, Shell, Extra Mile brand, and our own
                brand, Power Market. Currently, we are headquartered in Orange,
                California, and provide excellent operational facilities at over
